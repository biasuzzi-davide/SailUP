...
$html = str_replace(
    ...
    [
        ...
        optionalValueAttr($old['title']),
        optionalValueAttr($old['date']),
        htmlspecialchars($old['excerpt']),
        htmlspecialchars($old['content']),
        optionalValueAttr($old['image']),
        optionalValueAttr($old['alt']),
        optionalValueAttr((int)$old['reading_time'] > 0 ? (string)$old['reading_time'] : ''),
        $statusPlaceholder,
        $statusDraft,
        $statusPub,
        $extrasHtml,
