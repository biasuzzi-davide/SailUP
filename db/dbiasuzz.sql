...
(166, '../img/avatars/user_12.webp?v=1768231273', 'Avatar utente', 'Immagine', 12, NULL, NULL, '2026-01-12 15:21:14'),
(175, '../img/avatars/user_131.webp?v=1768324178', 'Avatar utente', 'Immagine', 131, NULL, NULL, '2026-01-13 17:09:38'),
(179, '../img/avatars/user_9.webp?v=1768381353', 'Avatar utente', 'Immagine', 9, NULL, NULL, '2026-01-14 09:02:33'),
(181, '../img/blog/flora-fauna-marinara.webp', 'Flora e fauna marina della costiera sorrentina', 'Immagine', NULL, NULL, 10, '2026-01-14 17:50:06'),
(182, '../img/blog/sorrento-perla-costiera.webp', 'Sorrento, perla della costiera amalfitana', 'Immagine', NULL, NULL, 12, '2026-01-14 17:52:03'),
(183, '../img/blog/fotografia-subacquea.webp', 'Fotografia subacquea e cattura di momenti', 'Immagine', NULL, NULL, 13, '2026-01-14 17:57:10'),
(184, '../img/blog/sostenibilita-marina.webp', 'Navigazione sostenibile e protezione marina', 'Immagine', NULL, NULL, 14, '2026-01-14 17:58:46'),
(185, '../img/blog/capri-leggenda-realta.webp', 'Isola di Capri: leggenda e realtà', 'Immagine', NULL, NULL, 15, '2026-01-14 17:59:48'),
(186, '../img/blog/ricette-cucina-marinara.webp', 'Ricette di cucina marinara da preparare a bordo', 'Immagine', NULL, NULL, 9, '2026-01-14 18:01:15'),
(187, '../img/blog/cale-costiera-sorrentina.webp', 'Spiagge e cale nascoste della costiera sorrentina', 'Immagine', NULL, NULL, 1, '2026-01-14 18:02:25'),
(188, '../img/blog/snorkeling-capri.webp', 'Guida allo snorkeling e fauna marina a Capri', 'Immagine', NULL, NULL, 2, '2026-01-14 18:03:38'),
(189, '../img/blog/ormeggio-sicurezza.webp', 'Tecniche di ormeggio sicuro per principianti', 'Immagine', NULL, NULL, 3, '2026-01-14 18:04:24'),
(190, '../img/blog/sicurezza-mare.webp', 'Protocolli di sicurezza e attrezzature obbligatorie', 'Immagine', NULL, NULL, 6, '2026-01-14 18:05:11'),
(191, '../img/avatars/user_132.webp?v=1768414006', 'Avatar utente', 'Immagine', 132, NULL, NULL, '2026-01-14 18:06:46'),
(192, '../img/prodotti/costieraamalfitana.webp', 'Costiera Amalfitana vista dal mare', 'Immagine', NULL, 'EXP-ESCURSIONE-001', NULL, '2026-01-14 20:07:38'),
(193, '../img/prodotti/tramontonapoli.webp', 'Coppia al tramonto con prosecco', 'Immagine', NULL, 'EXP-TRAMONTO-001', NULL, '2026-01-14 20:08:09'),
(194, '../img/prodotti/snork.webp', 'Snorkeling a Capri con pesci', 'Immagine', NULL, 'EXP-SNORKEL-001', NULL, '2026-01-14 20:08:26'),
(197, '../img/prodotti/prod_PRD-86AB070D.webp?v=1768422395', 'Persone che degustano', 'Immagine', NULL, 'PRD-86AB070D', NULL, '2026-01-14 20:26:35'),
(206, '../img/prodotti/prod_BARCA-VELA-001.webp?v=1768155062', 'Beneteau First 35 a vela', 'Immagine', NULL, 'BARCA-VELA-001', NULL, '2026-01-23 16:25:55'),
(208, '../img/prodotti/prod_PRD-F86512E8.webp?v=1768421611', 'Persone che prendono i pesci dalla rete da pesca', 'Immagine', NULL, 'PRD-F86512E8', NULL, '2026-01-23 16:31:02'),
(211, '../img/prodotti/prod_PRD-4417612E.webp?v=1768422553', 'Persone che discutono durante la guida', 'Immagine', NULL, 'PRD-4417612E', NULL, '2026-01-23 16:48:47');
...
('BARCA-GOMMONE-001', 'Noleggio', 'Gommone', NULL, 'Gommone Speed 250cv', 'Adrenalina e velocità. Ideale per chi ama l\'avventura sul mare. GPS', 'Un gommone potente e veloce, ideale per chi cerca adrenalina e avventura in mare. Perfetto per escursioni dinamiche e divertenti. GPS 7m 5h VHF', 450.00, 8, 0, 9.50, 1, '2025-12-23 12:11:10', '2026-01-22 10:00:09', 1),
...
('BARCA-VELA-001', 'Noleggio', 'Vela', NULL, 'Beneteau First 350', 'Vela sportiva con prestazioni eccellenti. Per velisti esperti.', 'Una barca a vela sportiva con prestazioni eccellenti, perfetta per velisti esperti che cercano avventura e sfida. Ciao', 400.00, 6, 0, 7.00, 1, '2025-12-23 12:11:10', '2026-01-22 09:24:25', 1),
