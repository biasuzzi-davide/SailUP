...
CREATE TABLE IF NOT EXISTS Prodotto (
    ...
    Tipologia_Experience VARCHAR(30) NULL, 
    ...
    -- VINCOLO: Per assicurare l'integrità dei dati
    CHECK (
        (Tipo_Prodotto = 'Noleggio' AND Tipologia_Experience IS NULL) OR
        (Tipo_Prodotto = 'Experience') AND Tipologia_Experience IS NOT NULL
    )
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
