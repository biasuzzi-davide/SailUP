...
- *Compatibilità e design responsivo:* Il sito è stato testato sui principali _browser_ web moderni, tra cui Google Chrome, Opera, Mozilla Firefox, Safari e Microsoft Edge per accertarci che venissero renderizzati correttamente. Il design responsivo è stato verificato a diverse risoluzioni e dispositivi attraverso i seguenti strumenti:
  - *Polypane:* Un _browser_ dedicato allo sviluppo web che permette di visualizzare simultaneamente il sito su più _viewport_ e profili di dispositivo, semplificando notevolmente i test di _responsive design_ senza dover ricaricare la pagina su finestre separate.
  - *BrowserStack:* Piattaforma _cloud_ che consente di testare il sito su una vasta gamma di dispositivi reali e sistemi operativi senza doverli fisicamente possedere. Abbiamo verificato la resa sugli ultimi modelli di smartphone dei principali produttori — Apple, Samsung, Google, OnePlus, Motorola, Xiaomi, Vivo, Oppo, Huawei e Realme — nonché su desktop con sistemi operativi macOS e Windows, coprendo così una platea di dispositivi che sarebbe stato impossibile replicare fisicamente.

  Non sono state invece prese in considerazione versioni più vecchie dei _browser_, considerato il profilo dell'utenza target del sito orientata all'utilizzo di dispositivi moderni.
